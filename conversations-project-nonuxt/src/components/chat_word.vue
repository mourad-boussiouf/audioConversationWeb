<template>
  <div id="chat">
    ...
    <conversation_word v-if="activeConversation" :active-conversation="activeConversation" :name="name" />
  </div>
</template>

<script>
import {Client as ConversationsClient} from "@twilio/conversations"
import conversation_word from "./conversation_word"
export default {
	components: { conversation_word },
	data() {
		return {
			statusString: "",
